...
<app-alert _ngcontent-mvt-c171=""><label style="  position: absolute;
  right: 70px;
  padding: 10px;" for="menuToggle" class="toggleButton md-button md-button--raised">Karakter Oluştur</label>
    <h4 style="position: absolute; color: #ffbb00;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Karakterlerin</h4>
    <div _ngcontent-mvt-c170="" class="notice-container type-info">
        <div _ngcontent-mvt-c170="" class="notice-icon"><br>
            <div _ngcontent-mvt-c170="" class="notice-content">
            </div>
        </div> <?php
